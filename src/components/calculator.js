  ...
  render() {
    return (
      <div className="calculator-container text-center mx-auto">
        <input className="result-field border-0 text-end text-white fs-3 fw-bold" type="text" name="result-field" />
        <div className="row btn-container text-center mx-auto">
          ...
          <button className="btn btn-outline-secondary rounded-0 col" type="button">%</button>
          <button className="rounded-0 border-secondary operator col" type="button">÷</button>
        </div>
        <div className="row btn-container text-center mx-auto">
          ...
          <button className="rounded-0 border-secondary col operator" type="button">x</button>
        </div>
        <div className="row btn-container text-center mx-auto">
          ...
          <button className="rounded-0 border-secondary col operator" type="button">-</button>
        </div>
        <div className="row btn-container text-center mx-auto">
